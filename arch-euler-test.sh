...
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-euler clean
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-euler ex19

rm -f arch-euler-test1.out
bsub -o arch-euler-test1.out ./src/snes/examples/tutorials/ex19 -da_refine 3 -snes_monitor_short -pc_type mg -ksp_type fgmres -pc_mg_type full

rm -f arch-euler-test2.out
bsub -n 2 -o arch-euler-test2.out mpirun ./src/snes/examples/tutorials/ex19 -da_refine 3 -snes_monitor_short -pc_type mg -ksp_type fgmres -pc_mg_type full
...
echo "  cat arch-euler-test1.out"
echo "  cat arch-euler-test2.out"
