...
echo '  cat petsc_ex43_gcr_test1-'$HOSTNAME'-n'$TASKS'-j'$CPUS'-d'$THREADS'-mx'$MX'-my'$MY'.out'
echo '  cat petsc_ex43_gcr_test2-'$HOSTNAME'-n'$TASKS'-j'$CPUS'-d'$THREADS'-mx'$MX'-my'$MY'.out'
echo '  cat petsc_ex43_gcr_test3-'$HOSTNAME'-n'$TASKS'-j'$CPUS'-d'$THREADS'-mx'$MX'-my'$MY'.out'
echo '  cat petsc_ex43_pipegcr_test1-'$HOSTNAME'-n'$TASKS'-j'$CPUS'-d'$THREADS'-mx'$MX'-my'$MY'.out'
echo '  cat petsc_ex43_pipegcr_test2-'$HOSTNAME'-n'$TASKS'-j'$CPUS'-d'$THREADS'-mx'$MX'-my'$MY'.out'
echo '  cat petsc_ex43_pipegcr_test3-'$HOSTNAME'-n'$TASKS'-j'$CPUS'-d'$THREADS'-mx'$MX'-my'$MY'.out'
