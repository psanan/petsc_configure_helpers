...
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-cray-xc30-daint-32bitind clean
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-cray-xc30-daint-32bitind ex19

# First test - single process
rm -f arch-cray-xc30-daint-32bitind-test1.out petsc_ex19_test1.batch
...
echo '#SBATCH --output=arch-cray-xc30-daint-32bitind-test1.out' >> petsc_ex19_test1.batch
...
rm petsc_ex19_test1.batch
 ...
 rm -f arch-cray-xc30-daint-32bitind-test2.out petsc_ex19_test2.batch
 ...
 if [ $USER == schnepp ]; then
   echo '#SBATCH --account=c05' >> petsc_ex19_test2.batch # SMS has to use this line
fi;
 echo '#SBATCH --output=arch-cray-xc30-daint-32bitind-test2.out' >> petsc_ex19_test2.batch
...
echo "  cat arch-cray-xc30-daint-32bitind-test1.out"
echo "  cat arch-cray-xc30-daint-32bitind-test2.out"
