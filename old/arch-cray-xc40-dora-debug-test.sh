...
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-cray-xc40-dora-debug clean
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-cray-xc40-dora-debug ex19

# First test - single process
rm -f arch-cray-xc40-dora-debug-test1.out petsc_ex19_test1.batch
...
echo '#SBATCH --output=arch-cray-xc40-dora-debug-test1.out' >> petsc_ex19_test1.batch
...
rm -f arch-cray-xc40-dora-debug-test2.out petsc_ex19_test2.batch
...
echo '#SBATCH --output=arch-cray-xc40-dora-debug-test2.out' >> petsc_ex19_test2.batch
if [ $USER == schnepp ]; then
  echo '#SBATCH --account=c05' >> petsc_ex19_test1.batch # SMS has use this line
fi;
...
echo "  cat arch-cray-xc40-dora-debug-test1.out"
echo "  cat arch-cray-xc40-dora-debug-test2.out"
