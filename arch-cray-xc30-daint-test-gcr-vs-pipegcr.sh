...
echo '#SBATCH --time=00:00:60' >> petsc_ex43_gcr_test4.batch
...
echo '#SBATCH --time=00:00:60' >> petsc_ex43_gcr_test5.batch
...
echo '#SBATCH --time=00:00:60' >> petsc_ex43_pipegcr_test4.batch
...
echo '#SBATCH --time=00:00:60' >> petsc_ex43_pipegcr_test5.batch
...
echo "${redColor}Grep for the execution times using${noColor}"
