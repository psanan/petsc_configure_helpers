...
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-cray-xc40-dora clean
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-cray-xc40-dora ex19

# First test - single process
rm -f arch-cray-xc40-dora-test1.out petsc_ex19_test1.batch
...
echo "  cat arch-cray-xc40-dora-test1.out"
echo "  cat arch-cray-xc40-dora-test2.out"
