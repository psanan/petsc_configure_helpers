...
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-gnu-xc30-daint-debug clean
make -C src/snes/examples/tutorials PETSC_DIR=../../../.. PETSC_ARCH=arch-gnu-xc30-daint-debug ex19

# First test - single process
rm -f arch-gnu-xc30-daint-debug-test1.out petsc_ex19_test1.batch
...
echo '#SBATCH --output=arch-gnu-xc30-daint-debug-test1.out' >> petsc_ex19_test1.batch
...
rm petsc_ex19_test1.batch
 ...
 rm -f arch-gnu-xc30-daint-debug-test2.out petsc_ex19_test2.batch
...
echo '#SBATCH --account=c05' >> petsc_ex19_test2.batch
 echo '#SBATCH --output=arch-gnu-xc30-daint-debug-test2.out' >> petsc_ex19_test2.batch
...
echo "  cat arch-gnu-xc30-daint-debug-test1.out"
echo "  cat arch-gnu-xc30-daint-debug-test2.out"
